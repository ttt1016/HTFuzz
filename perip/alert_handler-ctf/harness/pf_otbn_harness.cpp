// PickerFuzz per-IP C++ harness — otbn
#include <verilated.h>
...
// Whitebox signals: controller FSM + URND xoshiro 状态 + RND 数据 + 错误
static SigEntry g_sigs[] = {
    {"u_dut.controller_state", nullptr, 1, false},
    {"u_dut.urnd_xoshiro", nullptr, 8, true},
    {"u_dut.rnd_data", nullptr, 8, true},
    {"u_dut.rnd_valid", nullptr, 1, false},
    {"u_dut.rnd_err", nullptr, 1, false},
    {"u_dut.busy_execute", nullptr, 1, false},
    {"u_dut.start_stop_fatal", nullptr, 1, false},
};
