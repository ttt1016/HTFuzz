// PickerFuzz per-IP C++ harness — rv_timer
#include <verilated.h>
#include "Vrv_timer_perip_tb.h"
#include "Vrv_timer_perip_tb___024root.h"
#include <cstdio>
#include <cstdlib>
#include <cstring>
#include <cstdint>
...
static Vrv_timer_perip_tb* dut = nullptr;
static Vrv_timer_perip_tb___024root* rootp = nullptr;
static uint64_t main_time = 0;

struct SigEntry { const char* name; void* ptr; int words; bool is_wide; };

// Whitebox signals: tick 节拍计数器 + mtime 低字（hw2reg[1]）+ 中断置位（hw2reg[0]）
static SigEntry g_sigs[] = {
    {"u_core.tick_count", nullptr, 1, false},
    {"u_dut.mtime_lo", nullptr, 1, false},
    {"u_dut.intr_set", nullptr, 1, false},
};
