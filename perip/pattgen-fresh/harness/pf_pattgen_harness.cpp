// PickerFuzz per-IP C++ harness — pattgen
#include <verilated.h>
#include "Vpattgen_perip_tb.h"
#include "Vpattgen_perip_tb___024root.h"
#include <cstdio>
#include <cstdlib>
#include <cstring>
#include <cstdint>
...
static Vpattgen_perip_tb* dut = nullptr;
static Vpattgen_perip_tb___024root* rootp = nullptr;
static uint64_t main_time = 0;

struct SigEntry { const char* name; void* ptr; int words; bool is_wide; };

// Whitebox signals: ch0/ch1 计数器 + 完成事件
static SigEntry g_sigs[] = {
    {"chan0.clk_cnt_q", nullptr, 1, false},
    {"chan0.bit_cnt_q", nullptr, 1, false},
    {"chan0.rep_cnt_q", nullptr, 1, false},
    {"chan0.complete_q", nullptr, 1, false},
    {"chan1.clk_cnt_q", nullptr, 1, false},
    {"chan1.bit_cnt_q", nullptr, 1, false},
    {"chan1.rep_cnt_q", nullptr, 1, false},
    {"chan1.complete_q", nullptr, 1, false},
};
...
static void bind_signals() {
    for (int i = 0; i < g_nsig; i++) {
        ...
        void* p = nullptr;
        if (0) {}
        else if (strcmp(n, "chan0.clk_cnt_q") == 0) p = &rootp->pattgen_perip_tb__DOT__u_dut__DOT__u_pattgen_core__DOT__chan0__DOT__clk_cnt_q;
        else if (strcmp(n, "chan0.bit_cnt_q") == 0) p = &rootp->pattgen_perip_tb__DOT__u_dut__DOT__u_pattgen_core__DOT__chan0__DOT__bit_cnt_q;
        else if (strcmp(n, "chan0.rep_cnt_q") == 0) p = &rootp->pattgen_perip_tb__DOT__u_dut__DOT__u_pattgen_core__DOT__chan0__DOT__rep_cnt_q;
        else if (strcmp(n, "chan0.complete_q") == 0) p = &rootp->pattgen_perip_tb__DOT__u_dut__DOT__u_pattgen_core__DOT__chan0__DOT__complete_q;
        else if (strcmp(n, "chan1.clk_cnt_q") == 0) p = &rootp->pattgen_perip_tb__DOT__u_dut__DOT__u_pattgen_core__DOT__chan1__DOT__clk_cnt_q;
        else if (strcmp(n, "chan1.bit_cnt_q") == 0) p = &rootp->pattgen_perip_tb__DOT__u_dut__DOT__u_pattgen_core__DOT__chan1__DOT__bit_cnt_q;
        else if (strcmp(n, "chan1.rep_cnt_q") == 0) p = &rootp->pattgen_perip_tb__DOT__u_dut__DOT__u_pattgen_core__DOT__chan1__DOT__rep_cnt_q;
        else if (strcmp(n, "chan1.complete_q") == 0) p = &rootp->pattgen_perip_tb__DOT__u_dut__DOT__u_pattgen_core__DOT__chan1__DOT__complete_q;
        g_sigs[i].ptr = p;
    }
}
