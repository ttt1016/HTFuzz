// PickerFuzz per-IP wrapper — rv_timer standalone DUT
module rv_timer_perip_tb (
  input  logic clk_i,
  input  logic rst_ni,
  ...
  prim_alert_pkg::alert_rx_t [rv_timer_reg_pkg::NumAlerts-1:0] alert_rx;
  assign alert_rx = 0;

  logic intr_timer_expired;
  ...
  rv_timer #(
    ...
    .intr_timer_expired_hart0_timer0_o (intr_timer_expired)
  );
