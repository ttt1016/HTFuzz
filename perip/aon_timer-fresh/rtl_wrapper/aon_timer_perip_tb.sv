// PickerFuzz per-IP wrapper — aon_timer standalone DUT
module aon_timer_perip_tb (
  input  logic clk_i,
  input  logic rst_ni,
  ...
  prim_alert_pkg::alert_rx_t [aon_timer_reg_pkg::NumAlerts-1:0] alert_rx;
  assign alert_rx = 0;

  logic intr_wkup, intr_wdog, nmi_wdog, wkup_req, rst_req;
  logic sleep_mode;
  assign sleep_mode = 0;
  ...
  aon_timer u_dut (
    ...
    .intr_wkup_timer_expired_o (intr_wkup),
    .intr_wdog_timer_bark_o    (intr_wdog),
    .nmi_wdog_timer_bark_o     (nmi_wdog),
    .wkup_req_o  (wkup_req),
