// PickerFuzz per-IP C++ harness — aon_timer
#include <verilated.h>
#include "Vaon_timer_perip_tb.h"
#include "Vaon_timer_perip_tb___024root.h"
#include <cstdio>
#include <cstdlib>
#include <cstring>
#include <cstdint>
...
static Vaon_timer_perip_tb* dut = nullptr;
static Vaon_timer_perip_tb___024root* rootp = nullptr;
static uint64_t main_time = 0;

struct SigEntry { const char* name; void* ptr; int words; bool is_wide; };

// Whitebox signals: CDC-synced counters (wkup/wdog) + prescale
static SigEntry g_sigs[] = {
    {"u_reg.wdog_count_src_q", nullptr, 1, false},
    {"u_reg.wdog_count_dst_qs", nullptr, 1, false},
    {"u_core.prescale_count_q", nullptr, 1, false},
    {"u_dut.aon_wkup_intr_set", nullptr, 1, false},
    {"u_dut.aon_wdog_intr_set", nullptr, 1, false},
    {"tb.div_cnt", nullptr, 1, false},
};
