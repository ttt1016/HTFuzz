...
static void bind_signals() {
    for (int i = 0; i < g_nsig; i++) {
        ...
        void* p = nullptr;
        (void)p;
        if (strcmp(n, "csr.csr_we_int") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__cs_registers_i__DOT__csr_we_int;
        ...
        else if (strcmp(n, "u_dut.alu_operand_a") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__alu_operand_a;
        else if (strcmp(n, "u_dut.alu_operand_b") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__alu_operand_b;
        else if (strcmp(n, "u_dut.alu_operator") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__alu_operator;
        else if (strcmp(n, "u_dut.branch_set") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__branch_set;
        else if (strcmp(n, "u_dut.csr_wdata_int") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__cs_registers_i__DOT__csr_wdata_int;
        else if (strcmp(n, "u_dut.csr_we_int") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__cs_registers_i__DOT__csr_we_int;
        else if (strcmp(n, "u_dut.ctrl_fsm_cs") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__controller_i__DOT__ctrl_fsm_cs;
        else if (strcmp(n, "u_dut.ctrl_fsm_ns") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__controller_i__DOT__ctrl_fsm_ns;
        else if (strcmp(n, "u_dut.debug_mode_q") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__controller_i__DOT__debug_mode_q;
        else if (strcmp(n, "u_dut.div_counter_q") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__div_counter_q;
        else if (strcmp(n, "u_dut.exc_req_q") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__controller_i__DOT__exc_req_q;
        else if (strcmp(n, "u_dut.fetch_addr_q") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__if_stage_i__DOT__gen_prefetch_buffer__DOT__prefetch_buffer_i__DOT__fetch_addr_q;
        else if (strcmp(n, "u_dut.illegal_insn_q") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__controller_i__DOT__illegal_insn_q;
        else if (strcmp(n, "u_dut.load_err_q") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__controller_i__DOT__load_err_q;
        else if (strcmp(n, "u_dut.lsu_err_q") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__load_store_unit_i__DOT__lsu_err_q;
        else if (strcmp(n, "u_dut.lsu_req_dec") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__lsu_req_dec;
        else if (strcmp(n, "u_dut.lsu_we") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__lsu_we;
        else if (strcmp(n, "u_dut.mcause_d") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__cs_registers_i__DOT__mcause_d;
        else if (strcmp(n, "u_dut.md_state_q") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__ex_block_i__DOT__gen_multdiv_fast__DOT__multdiv_i__DOT__md_state_q;
        else if (strcmp(n, "u_dut.mepc_d") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__cs_registers_i__DOT__mepc_d;
        else if (strcmp(n, "u_dut.mstatus_d") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__cs_registers_i__DOT__mstatus_d;
        else if (strcmp(n, "u_dut.nmi_mode_q") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__controller_i__DOT__nmi_mode_q;
        else if (strcmp(n, "u_dut.pmp_err_q") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__load_store_unit_i__DOT__pmp_err_q;
        else if (strcmp(n, "u_dut.store_err_q") == 0) p = &rootp->ibex_mini_tb__DOT__u_dut__DOT__id_stage_i__DOT__controller_i__DOT__store_err_q;
        g_sigs[i].ptr = p;
    }
}
