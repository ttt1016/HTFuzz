...
//
parameter int unsigned Lc2HcTrCyc = 4;  // VERILATOR FIX: accelerated  // ((109+1)+(3+1))x5 = 570 us
parameter int unsigned Hc2LcTrCyc = 4;  // VERILATOR FIX: accelerated  // ((139+1)+(3+1))x5 = 720 us
//
