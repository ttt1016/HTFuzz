...
#(
  ...
  /////////
  kmac_st_e st, st_d;
  logic [7:0] st_err_ct, st_err_ct_d;
  ...
  always_comb begin
    ...
    unique case (st)
      ...
      StTerminalError: begin
        ...
        st_d = st;
        if (st_err_ct < 8'd100) begin
          st_err_ct_d = st_err_ct + 1'b 1;
          sparse_fsm_error_o = 1'b 0;
        end else begin
  ...
  always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) st_err_ct <= '0;
    else         st_err_ct <= st_err_ct_d;
  end
