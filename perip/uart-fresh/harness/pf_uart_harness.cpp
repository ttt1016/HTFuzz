...
static void bind_signals() {
    for (int i = 0; i < g_nsig; i++) {
        ...
        void* p = nullptr;
        (void)p;
        if (strcmp(n, "u_dut.u_reg.__Vcellout__u_intr_state_rx_break_err__q") == 0) p = &rootp->uart_perip_tb__DOT__u_dut__DOT__u_reg__DOT____Vcellout__u_intr_state_rx_break_err__q;
        ...
        else if (strcmp(n, "u_dut.u_reg.u_wdata.wr_en") == 0) p = &rootp->uart_perip_tb__DOT__u_dut__DOT__u_reg__DOT__u_ctrl_llpbk__DOT__wr_en;
        ...
        else if (strcmp(n, "u_dut.uart_core.intr_hw_rx_frame_err.g_intr_event.new_event") == 0) p = &rootp->uart_perip_tb__DOT__u_dut__DOT__uart_core__DOT__intr_hw_rx_break_err__DOT__g_intr_event__DOT__new_event;
        else if (strcmp(n, "u_dut.uart_core.intr_hw_rx_overflow.g_intr_event.new_event") == 0) p = &rootp->uart_perip_tb__DOT__u_dut__DOT__uart_core__DOT__intr_hw_rx_break_err__DOT__g_intr_event__DOT__new_event;
        else if (strcmp(n, "u_dut.uart_core.intr_hw_rx_parity_err.g_intr_event.new_event") == 0) p = &rootp->uart_perip_tb__DOT__u_dut__DOT__uart_core__DOT__intr_hw_rx_break_err__DOT__g_intr_event__DOT__new_event;
        else if (strcmp(n, "u_dut.uart_core.intr_hw_rx_timeout.g_intr_event.new_event") == 0) p = &rootp->uart_perip_tb__DOT__u_dut__DOT__uart_core__DOT__intr_hw_rx_break_err__DOT__g_intr_event__DOT__new_event;
        else if (strcmp(n, "u_dut.uart_core.intr_hw_tx_done.g_intr_event.new_event") == 0) p = &rootp->uart_perip_tb__DOT__u_dut__DOT__uart_core__DOT__intr_hw_rx_break_err__DOT__g_intr_event__DOT__new_event;
