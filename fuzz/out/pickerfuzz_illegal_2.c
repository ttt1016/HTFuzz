// Auto-generated by fuzz_engine.py — PickerFuzz mutation illegal
// seed=hmac_smoketest  mut_id=2
#include "ot_secfuzz.h"

#define PF_N_TXN 5
// txn: {addr, data, mask, op}  op: 0=PutFull 1=PutPartial 4=Get
static const uint32_t pf_txn[PF_N_TXN][4] = {
    {0x411100a4u, 0xdeadbeefu, 0x000fu, 4u},
    {0x411100e0u, 0xdeadbeefu, 0x000fu, 0u},
    {0x411100acu, 0xdeadbeefu, 0x000fu, 4u},
    {0x4111006cu, 0xdeadbeefu, 0x000fu, 4u},
    {0x41110084u, 0xdeadbeefu, 0x000fu, 4u},
};

OTTF_DEFINE_TEST_CONFIG();
bool test_main(void) {
    FUZZ_STEP(2, "PICKERFUZZ illegal", "hjson-spec oracle");
    ...
    if (anomalies == 0) FUZZ_PASS(2, "no anomaly");
    else FUZZ_FAIL(2, "anomaly detected");
    fuzz_print_summary();
    return anomalies == 0;
}
