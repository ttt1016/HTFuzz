// Auto-generated by fuzz_engine.py — PickerFuzz mutation boundary
// seed=hmac_smoketest  mut_id=3
#include "ot_secfuzz.h"

#define PF_N_TXN 8
// txn: {addr, data, mask, op}  op: 0=PutFull 1=PutPartial 4=Get
static const uint32_t pf_txn[PF_N_TXN][4] = {
    {0x41110010u, 0x0000003fu, 0x000fu, 0u},
    {0x41110010u, 0x00000000u, 0x000fu, 0u},
    {0x41110014u, 0x0000000fu, 0x000fu, 0u},
    {0x411100e8u, 0xffffffffu, 0x000fu, 0u},
    {0x41110014u, 0x00000004u, 0x000fu, 0u},
    {0x411100e4u, 0x00000001u, 0x000fu, 0u},
    {0x41110010u, 0x0000ffffu, 0x000fu, 0u},
    {0x41110014u, 0x00000002u, 0x000fu, 0u},
};

OTTF_DEFINE_TEST_CONFIG();
bool test_main(void) {
    FUZZ_STEP(3, "PICKERFUZZ boundary", "hjson-spec oracle");
    ...
    if (anomalies == 0) FUZZ_PASS(3, "no anomaly");
    else FUZZ_FAIL(3, "anomaly detected");
    fuzz_print_summary();
    return anomalies == 0;
}
