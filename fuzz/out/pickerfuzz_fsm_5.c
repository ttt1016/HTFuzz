// Auto-generated by fuzz_engine.py — PickerFuzz mutation fsm
// seed=hmac_smoketest  mut_id=5
...
static const uint32_t pf_txn[PF_N_TXN][4] = {
    ...
    {0x41111000u, 0x41424344u, 0x000fu, 0u},
    {0x41110014u, 0x00000002u, 0x000fu, 0u},
    {0x41111000u, 0x45464748u, 0x000fu, 0u},
    {0x41110018u, 0x00000000u, 0x000fu, 4u},
    {0x41110014u, 0x00000001u, 0x000fu, 0u},
    {0x41110014u, 0x00000001u, 0x000fu, 0u},
    {0x4111001cu, 0x00000000u, 0x000fu, 4u},
    {0x41110010u, 0x00000422u, 0x000fu, 0u},
    {0x41110014u, 0x00000001u, 0x000fu, 0u},
    {0x41110010u, 0x00000500u, 0x000fu, 0u},
    {0x41110014u, 0x00000002u, 0x000fu, 0u},
    {0x4111001cu, 0x00000000u, 0x000fu, 4u},
};
...
bool test_main(void) {
    FUZZ_STEP(5, "PICKERFUZZ fsm", "hjson-spec oracle");
    ...
    if (anomalies == 0) FUZZ_PASS(5, "no anomaly");
    else FUZZ_FAIL(5, "anomaly detected");
    fuzz_print_summary();
    return anomalies == 0;
}
