...
DIRECTED = {
    ...
    "gpio": [
        {"wr": (16, 4294967295), "step": 3},
        {"rd": 16},
        {"wr": (20, 4294967295), "step": 3},
        {"rd": 20},
        {"wr": (24, 4294967295), "step": 3},
        {"wr": (40, 1), "step": 3},
        {"rd": 40},
        {"reset": True},
    ],
...
def load_trace(dut_dir, tag, module):
    ...
    p = subprocess.run(
        [
            "python3",
            f"{PF}/scripts/dut_trace.py",
            dut_dir,
            module,
            f"{PF}/traces/{module}_regmap.json",
            out,
            "0",
        ],
        capture_output=True,
...
def main():
    ...
    json.dump(
        {"module": module, "verdict": verdict, "findings": findings},
        open(out, "w"),
        indent=1,
        ensure_ascii=False,
    )
